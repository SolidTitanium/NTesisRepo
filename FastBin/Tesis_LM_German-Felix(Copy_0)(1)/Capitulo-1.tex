\chapter{Espacios M\'etricos, Cubiertas y Complejos Simpliciales}
...
De la misma manera, podemos definir la distancia de Hausdorff
para subconjuntos cerrados no compactos de $M$,
pero en este caso la distancia puede tomar un valor infinito y la topolog\'ia de F(M),
el conjunto de subconjuntos cerrados de $M$,
comienza a depender de $\rho$ adem\'as de la topolog\'ia de M.
Por otro lado, tambi\'en podemos definir la distancia de Hausdorff entre
cualesquiera dos subconjuntos de $M$ si consideramos la distancia entre sus cerraduras,
lo cual otorga una pre-m\'etrica en el conjunto de subconjuntos de M
ya que la distancia de Hausdorff entre dos subconjutos sera $0$ si sus cerraduras son iguales.
...
puntos linealmente independientes, el simplejo $k$-dimensional
...
puntos en $\mathbb{R}^{d}$ que cumplen $\rho_{\mathbb{X}}\left(x_{i},x_{j}\right)\leq\alpha$ para todo
...
caminos y, en particular, tienen la misma homolog\'ia.
